...
*/
	...
	function WDG_SpecialRecentPostsFree() {
		...
		$this->WP_Widget('WDG_SpecialRecentPostsFree', 'Special Recent Posts FREE Edition', $widget_ops);
	...
	<dl class="srp-wdg-accordion">
		...
		<dd class="srp-widget-optionlist-dd-posts">
			<ul class="srp-widget-optionlist-posts srp-widget-optionlist">
				...
				<li>
					...
					<small><?php _e('*(F = Month name | j = Day of the month | S = ordinal suffix for the day of the month | Y = Year)', SRP_TRANSLATION_ID); ?></small>
				</li>
		...
		<dd class="srp-widget-optionlist-dd-credits">
			<ul class="srp-widget-optionlist-credits srp-widget-optionlist">
				...
				<!-- BOF Credits Text. -->
				<li>
					<?php _e('<p>The <strong>Special Recent Posts FREE Edition</strong> plugin is created, developed and supported by <a href="http://www.lucagrandicelli.com" title="Luca Grandicelli Website">Luca Grandicelli</a></p><strong>SRP Version: ' . SRP_PLUGIN_VERSION . '</strong>', SRP_TRANSLATION_ID); ?>
				</li>
				<!-- EOF Credits Text. -->

				<!-- BOF SRP PRO Link. -->
				<li>
					<a href='http://codecanyon.net/item/special-recent-posts-pro/552356'>Upgrade to Special Recent Posts PRO!</a>
				</li>
				<!-- EOF SRP PRO Link. -->
			</ul>
		</dd>
